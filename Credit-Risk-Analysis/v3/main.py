...
@app.get("/loan_prediction_form/", response_class=HTMLResponse)
async def get_loan_prediction_form(request: Request):
    # Render the template with the necessary context
    return templates.TemplateResponse("loan_prediction_form.html", {"request": request})
...
def predict(name: str = Form(...),
    ...
    # ARMAR EL PIPELINE (PARA EL PREPROCESSING, ENCODING, PREDICT)
